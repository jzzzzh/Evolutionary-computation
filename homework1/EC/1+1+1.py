...
def mymain():
    ...
    for i in range(0,tryTimes):
        ...
        listmax.append(rankListBestN[-1][3])
        listave.append(numpy.mean(rankListBestN[:][3]))
        ...
        list1 = nextGenList1
        list2 = nextGenList2
    return listbest,listmax,listave
...
if __name__ == '__main__':
    ...
    for i in range(0, time):
        ...
        listmmax.append(listmax)
        listaave.append(listave)
    ...
    for i in range(0,time-1):
        listavveave.append(numpy.mean(listaave[:][i]))
        listmmaxave.append(numpy.mean(listmmax[:][i]))
        listbestave.append(numpy.mean(finallist[:][i]))
    plt.plot(listavveave)
    plt.plot(listmmaxave)
    plt.plot(listbestave)
    plt.show()